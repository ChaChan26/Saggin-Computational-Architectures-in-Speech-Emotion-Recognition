...
* To retrain the best model (93%): Run [notebooks/train_lightgbm.ipynb](file:///c:/Emotion/Saggin-Computational-Architectures-in-Speech-Emotion-Recognition/notebooks/train_lightgbm.ipynb) or execute `py src/train_lightgbm.py`.
